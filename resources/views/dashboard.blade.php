<x-app-layout>
    <x-slot name="header" class="">
        <h2 class="mt-8 -mb-4 text-2xl font-bold leading-tight text-center text-gold cinzel brightness-110">
    ...
    @else
        <div class="py-12 bg-black">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden text-lg font-bold text-center border-8 shadow-sm cardo-bold text-gray-50 border-gold sm:rounded-lg">
